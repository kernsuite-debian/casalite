...
#
        ...
        if trec.has_key('imfit') and casac.utils().verify(mytmp, trec['imfit']) :
            result = task_imfit.imfit(imagename, box, region, chans, stokes, mask, includepix, excludepix, residual, model, estimates, logfile, append, newestimates, complist, overwrite, dooff, offset, fixoffset, stretch, rms, noisefwhm, summary)
