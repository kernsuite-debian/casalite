...
from types import *
from task_listsdm import listsdm
class listsdm_cli_:
    __name__ = "listsdm"
    rkey = None
    ...
    def __init__(self) :
       self.__bases__ = (listsdm_cli_,)
       self.__doc__ = self.__call__.__doc__

       self.parameters={'sdm':None, }
...
Given an SDM directory, this task will print observation information to the logger and return a dictionary keyed by scan.
        ...
        self.__globals__['__last_task'] = 'listsdm'
        self.__globals__['taskname'] = 'listsdm'
        ###
        ...
        if useLocalDefaults :
           for item in function_signature_defaults.iteritems():
            ...
            myparams['sdm'] = sdm = self.parameters['sdm']
...
#
        ...
        trec = casac.casac.utils().torecord(pathname+'listsdm.xml')

        casalog.origin('listsdm')
        try :
          #if not trec.has_key('listsdm') or not casac.casac.utils().verify(mytmp, trec['listsdm']) :
            #return False

          casac.casac.utils().verify(mytmp, trec['listsdm'], True)
          scriptstr=['']
          ...
          if type(self.__call__.func_defaults) is NoneType:
              ...
              saveinputs('listsdm', 'listsdm.last', myparams, self.__globals__,scriptstr=scriptstr, do_save_inputs=do_full_logging)
...
#            paramgui.setGlobals({})
#
#        paramgui.runTask('listsdm', myf['_ip'])
#        paramgui.setGlobals({})
#
#
#
...
#
#
    def description(self, key='listsdm', subkey=None):
        desc={'listsdm': 'Lists observation information present in an SDM directory.',
               'sdm': 'Name of input SDM directory',
