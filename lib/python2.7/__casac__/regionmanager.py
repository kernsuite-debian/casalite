...
class regionmanager(_object):
    ...
    def box(self, *args, **kwargs):
        """
        box(self, blc, trc, inc, absrel, frac=False, comment) -> record *
    ...
    def frombcs(self, *args, **kwargs):
        """
        frombcs(self, csys, shape, box, chans, stokes, stokescontrol, region) -> record *
    ...
    def complement(self, *args, **kwargs):
        """
        complement(self, region, comment) -> record *
    ...
    def concatenation(self, *args, **kwargs):
        """
        concatenation(self, box, regions, comment) -> record *
    ...
    def deletefromtable(self, *args, **kwargs):
        """
        deletefromtable(self, tablename, regionname) -> bool
    ...
    def difference(self, *args, **kwargs):
        """
        difference(self, region1, region2, comment) -> record *
    ...
    def selectedchannels(self, *args, **kwargs):
        """
        selectedchannels(self, specification, shape) -> std::vector< int >
    ...
    def fromtextfile(self, *args, **kwargs):
        """
        fromtextfile(self, filename, shape, csys) -> record *
        ...
        Input Parameters:
        	filename	 List of text file containing the region description path 
        	shape		 Image shape. 0 
    ...
    def fromtext(self, *args, **kwargs):
        """
        fromtext(self, text, shape, csys) -> record *
    ...
    def fromfiletorecord(self, *args, **kwargs):
        """
        fromfiletorecord(self, filename, verbose=True, regionname) -> record *
    ...
    def tofile(self, *args, **kwargs):
        """
        tofile(self, filename, region) -> bool
    ...
    def fromrecordtotable(self, *args, **kwargs):
        """
        fromrecordtotable(self, tablename, regionname, regionrec, asmask=False, verbose=True) -> string
    ...
    def fromtabletorecord(self, *args, **kwargs):
        """
        fromtabletorecord(self, tablename, regionname, verbose=True) -> record *
    ...
    def intersection(self, *args, **kwargs):
        """
        intersection(self, regions, comment) -> record *
    ...
    def ispixelregion(self, *args, **kwargs):
        """
        ispixelregion(self, region) -> bool
    ...
    def isworldregion(self, *args, **kwargs):
        """
        isworldregion(self, region) -> bool
    ...
    def namesintable(self, *args, **kwargs):
        """
        namesintable(self, tablename) -> std::vector< std::string >
    ...
    def makeunion(self, *args, **kwargs):
        """
        makeunion(self, regions, comment) -> record *
    ...
    def wbox(self, *args, **kwargs):
        """
        wbox(self, blc, trc, pixelaxes, csys, absrel, comment) -> record *
    ...
    def wpolygon(self, *args, **kwargs):
        """
        wpolygon(self, x, y, pixelaxes, csys, absrel, comment) -> record *
