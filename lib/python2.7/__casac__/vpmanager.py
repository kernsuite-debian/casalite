...
class vpmanager(_object):
    ...
    def saveastable(self, *args, **kwargs):
        """
        saveastable(self, tablename) -> bool
    ...
    def loadfromtable(self, *args, **kwargs):
        """
        loadfromtable(self, tablename) -> bool
    ...
    def setcannedpb(self, *args, **kwargs):
        """
        setcannedpb(self, telescope, othertelescope, dopb=True, commonpb, dosquint=False, paincrement, usesymmetricbeam=False) -> record *
    ...
    def setpbairy(self, *args, **kwargs):
        """
        setpbairy(self, telescope, othertelescope, dopb=True, dishdiam, blockagediam, maxrad, reffreq, squintdir, squintreffreq, dosquint=False, paincrement, usesymmetricbeam=False) -> record *
    ...
    def setpbcospoly(self, *args, **kwargs):
        """
        setpbcospoly(self, telescope, othertelescope, dopb=True, coeff, scale, maxrad, reffreq, isthispb, squintdir, squintreffreq, dosquint=False, paincrement, usesymmetricbeam=False) -> record *
    ...
    def setpbgauss(self, *args, **kwargs):
        """
        setpbgauss(self, telescope, othertelescope, dopb=True, halfwidth, maxrad, reffreq, isthispb, squintdir, squintreffreq, dosquint=False, paincrement, usesymmetricbeam=False) -> record *
    ...
    def setpbinvpoly(self, *args, **kwargs):
        """
        setpbinvpoly(self, telescope, othertelescope, dopb=True, coeff, maxrad, reffreq, isthispb, squintdir, squintreffreq, dosquint=False, paincrement, usesymmetricbeam=False) -> record *
    ...
    def setpbnumeric(self, *args, **kwargs):
        """
        setpbnumeric(self, telescope, othertelescope, dopb=True, vect, maxrad, reffreq, isthispb, squintdir, squintreffreq, dosquint=False, paincrement, usesymmetricbeam=False) -> record *
    ...
    def setpbimage(self, *args, **kwargs):
        """
        setpbimage(self, telescope, othertelescope, dopb=True, realimage, imagimage, compleximage, antnames) -> record *
    ...
    def setpbpoly(self, *args, **kwargs):
        """
        setpbpoly(self, telescope, othertelescope, dopb=True, coeff, maxrad, reffreq, isthispb, squintdir, squintreffreq, dosquint=False, paincrement, usesymmetricbeam=False) -> record *
    ...
    def setpbantresptable(self, *args, **kwargs):
        """
        setpbantresptable(self, telescope, othertelescope, dopb=True, antresppath) -> bool
        ...
        Input Parameters:
        	...
        	othertelescope	 If telescope=='OTHER', specify name here 
        	dopb		 Should we apply the vp/pb to this telescope's data? true 
        	antresppath	 The path to the antenna responses table (absolute or relative to CASA data dir.) path 
    ...
    def setuserdefault(self, *args, **kwargs):
        """
        setuserdefault(self, vplistnum=-1, telescope, anttype) -> bool
    ...
    def getuserdefault(self, *args, **kwargs):
        """
        getuserdefault(self, telescope, anttype) -> int
    ...
    def getanttypes(self, *args, **kwargs):
        """
        getanttypes(self, telescope, obstime, freq, obsdirection) -> std::vector< std::string >
    ...
    def numvps(self, *args, **kwargs):
        """
        numvps(self, telescope, obstime, freq, obsdirection) -> int
    ...
    def getvp(self, *args, **kwargs):
        """
        getvp(self, telescope, antennatype, obstime, freq, obsdirection) -> record *
    ...
    def getvps(self, *args, **kwargs):
        """
        getvps(self, telescope, antennas, obstimestart, obstimeend, minfreq, maxfreq, obsdirection) -> record *
        ...
        Input Parameters:
        	...
        	obstimestart	 Time of the start of the observation (for versioning and reference frame calculations), e.g. 2011/12/12T00:00:00 1970/01/01T00:00:00 
        	obstimeend	 Time of the end of the observation (for versioning and reference frame calculations), e.g. 2011/12/12T00:00:00 1970/01/01T00:00:00 
        	minfreq		 Minimum frequency of the observation (may include reference frame, default: LSRK) 1GHz 
        	maxfreq		 Maximum frequency of the observation (may include reference frame, default: LSRK) 1GHz 
        	obsdirection	 Direction of the observation (may include reference frame, default: J2000), default: AZEL 0deg 90deg 
    ...
    def createantresp(self, *args, **kwargs):
        """
        createantresp(self, imdir, starttime, bandnames, bandminfreq, bandmaxfreq) -> bool
    ...
    def getrespimagename(self, *args, **kwargs):
        """
        getrespimagename(self, telescope, starttime, frequency, functype, anttype, azimuth, elevation, rectype, beamnumber=0) -> string
