...
if _swig_python_version_info >= (2, 7, 0):
    def swig_import_helper():
        ...
        mname = '.'.join((pkg, '_tableplot')).lstrip('.')
        try:
            return importlib.import_module(mname)
        except ImportError:
            return importlib.import_module('_tableplot')
...
class tableplot(_object):
    ...
    def selectdata(self, *args, **kwargs):
        """
        selectdata(self, taqlstring) -> bool
    ...
    def plotdata(self, *args, **kwargs):
        """
        plotdata(self, poption, labels, datastr) -> bool
    ...
    def iterplotstart(self, *args, **kwargs):
        """
        iterplotstart(self, poption, labels, datastr, iteraxes) -> bool
    ...
    def markregions(self, *args, **kwargs):
        """
        markregions(self, nrows=0, ncols=0, panel=1, region) -> bool
    ...
    def locatedata(self, *args, **kwargs):
        """
        locatedata(self, columnlist) -> bool
