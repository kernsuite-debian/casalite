...
class componentlist(_object):
    ...
    def open(self, *args, **kwargs):
        """
        open(self, filename, nomodify=False, log=True) -> bool
    ...
    def asciitocomponentlist(self, *args, **kwargs):
        """
        asciitocomponentlist(self, filename, asciifile, refer, format, direction, spectrum, flux, log=True) -> int
    ...
    def concatenate(self, *args, **kwargs):
        """
        concatenate(self, list, which, log=True) -> bool
    ...
    def remove(self, *args, **kwargs):
        """
        remove(self, which, log=True) -> bool
    ...
    def sort(self, *args, **kwargs):
        """
        sort(self, criteria, log=True) -> bool
    ...
    def sample(self, *args, **kwargs):
        """
        sample(self, direction, pixellatsize, pixellongsize, frequency) -> std::vector< double >
    ...
    def rename(self, filename, log=True):
        ...
        """
        return _componentlist.componentlist_rename(self, filename, log)
    ...
    def addcomponent(self, *args, **kwargs):
        """
        addcomponent(self, flux, fluxunit, polarization, dir, shape, majoraxis, minoraxis, positionangle, freq, spectrumtype, index=1.0, optionalparms, label) -> bool
        ...
        Input Parameters:
        	...
        	shape		 The new shape type. A string that is either 'point', 'Gaussian', or 'disk' disk Gaussian point 
        	majoraxis	 The width (FWHM in the case of a Gaussian) of the larger axis. A quantity with angular units 2.0arcmin 
        	minoraxis	 The width (FWHM in the case of a Gaussian) of the smaller axis. A quantity with angular units 1.0arcmin 
        	...
        	optionalparms	 optional parameters in vector (for future use) 0.0 
    ...
    def edit(self, which, log=True):
        ...
        """
        return _componentlist.componentlist_edit(self, which, log)
    ...
    def select(self, which):
        ...
        """
        return _componentlist.componentlist_select(self, which)
    ...
    def deselect(self, which):
        ...
        """
        return _componentlist.componentlist_deselect(self, which)
    ...
    def getlabel(self, which):
        ...
        """
        return _componentlist.componentlist_getlabel(self, which)
    ...
    def setlabel(self, which, value, log=True):
        ...
        """
        return _componentlist.componentlist_setlabel(self, which, value, log)
    ...
    def getfluxvalue(self, which):
        ...
        """
        return _componentlist.componentlist_getfluxvalue(self, which)
    ...
    def getfluxunit(self, which):
        ...
        """
        return _componentlist.componentlist_getfluxunit(self, which)
    ...
    def getfluxpol(self, which):
        ...
        """
        return _componentlist.componentlist_getfluxpol(self, which)
    ...
    def getfluxerror(self, which):
        ...
        """
        return _componentlist.componentlist_getfluxerror(self, which)


    def setflux(self, *args, **kwargs):
        """
        setflux(self, which, value, unit, polarization, error, log=True) -> bool
    ...
    def convertfluxunit(self, *args, **kwargs):
        """
        convertfluxunit(self, which, unit) -> bool
    ...
    def convertfluxpol(self, *args, **kwargs):
        """
        convertfluxpol(self, which, polarization) -> bool
    ...
    def getrefdir(self, which):
        ...
        """
        return _componentlist.componentlist_getrefdir(self, which)


    def getrefdirra(self, *args, **kwargs):
        """
        getrefdirra(self, which, unit, precision=6) -> string
    ...
    def getrefdirdec(self, *args, **kwargs):
        """
        getrefdirdec(self, which, unit, precision=6) -> string
    ...
    def getrefdirframe(self, which):
        ...
        """
        return _componentlist.componentlist_getrefdirframe(self, which)


    def setrefdir(self, *args, **kwargs):
        """
        setrefdir(self, which=1, ra, dec, log=True) -> bool
    ...
    def setrefdirframe(self, which, frame, log=True):
        ...
        """
        return _componentlist.componentlist_setrefdirframe(self, which, frame, log)
    ...
    def convertrefdir(self, which, frame):
        ...
        """
        return _componentlist.componentlist_convertrefdir(self, which, frame)
    ...
    def shapetype(self, which):
        ...
        """
        return _componentlist.componentlist_shapetype(self, which)
    ...
    def getshape(self, which):
        ...
        """
        return _componentlist.componentlist_getshape(self, which)


    def setshape(self, *args, **kwargs):
        """
        setshape(self, which, type, majoraxis, minoraxis, positionangle, majoraxiserror, minoraxiserror, positionangleerror, optionalparms, log=True) -> bool
        ...
        Input Parameters:
        	which		 A vector of indices specifying the components to modify. A vector with indices between 0 and one less than the list length, inclusively 
        	type		 The new shape type. A string that is either 'point', 'Gaussian', or 'disk' disk Gaussian Point 
        	...
        	positionangle	 The rotation of the axes with respect to the reference frame. A quantity with angular units 0.0deg 
        	majoraxiserror	 Error of width of the larger axis. A quantity with angular units 0.0arcmin 
        	...
        	optionalparms	 optional parameters in a vector (for future use) 0.0 
        	log		 Send a message to the logger true 
    ...
    def convertshape(self, *args, **kwargs):
        """
        convertshape(self, which, majoraxis, minoraxis, positionangle) -> bool
    ...
    def spectrumtype(self, which):
        ...
        """
        return _componentlist.componentlist_spectrumtype(self, which)
    ...
    def getspectrum(self, which):
        ...
        """
        return _componentlist.componentlist_getspectrum(self, which)


    def setstokesspectrum(self, *args, **kwargs):
        """
        setstokesspectrum(self, which, type, index, tabularfreqs, tabulari, tabularq, tabularu, tabularv, reffreq, frame) -> bool
    ...
    def setspectrum(self, *args, **kwargs):
        """
        setspectrum(self, which, type, index=0.0, tabularfreqs, tabularflux, tabularframe) -> bool
    ...
    def getfreq(self, which):
        ...
        """
        return _componentlist.componentlist_getfreq(self, which)
    ...
    def getfreqvalue(self, which):
        ...
        """
        return _componentlist.componentlist_getfreqvalue(self, which)
    ...
    def getfrequnit(self, which):
        ...
        """
        return _componentlist.componentlist_getfrequnit(self, which)
    ...
    def getfreqframe(self, which):
        ...
        """
        return _componentlist.componentlist_getfreqframe(self, which)


    def setfreq(self, *args, **kwargs):
        """
        setfreq(self, which, value, unit, log=True) -> bool
    ...
    def setfreqframe(self, *args, **kwargs):
        """
        setfreqframe(self, which, frame, log=True) -> bool
    ...
    def convertfrequnit(self, *args, **kwargs):
        """
        convertfrequnit(self, which, unit) -> bool
    ...
    def getcomponent(self, which, iknow=False):
        ...
        """
        return _componentlist.componentlist_getcomponent(self, which, iknow)
    ...
    def add(self, thecomponent, iknow=True):
        ...
        """
        return _componentlist.componentlist_add(self, thecomponent, iknow)


    def replace(self, *args, **kwargs):
        """
        replace(self, which, list, whichones) -> bool
    ...
    def summarize(self, which=-1):
        ...
        """
        return _componentlist.componentlist_summarize(self, which)
    ...
    def iscomponentlist(self, tool):
        ...
        """
        return _componentlist.componentlist_iscomponentlist(self, tool)
