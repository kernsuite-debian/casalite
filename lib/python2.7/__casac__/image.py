...
class image(_object):
    ...
    def imagecalc(self, *args, **kwargs):
        """
        imagecalc(self, outfile, pixels, overwrite=False, imagemd, prec) -> image
        ...
        Input Parameters:
        	...
        	prec		 Precision for the output image pixels. 'float' or 'double' (minimum match supported) float 
    ...
    def collapse(self, *args, **kwargs):
        """
        collapse(self, function, axes, outfile, region, box, chans, stokes, mask, overwrite=False, stretch=False) -> image
        ...
        Input Parameters:
        	...
        	stretch		 Stretch the mask if necessary and possible? Default value is False. false 
    ...
    def decimate(self, *args, **kwargs):
        """
        decimate(self, outfile, axis=0, factor=1, method, region, mask, overwrite=False, stretch=False) -> image
    ...
    def dohistory(self, *args, **kwargs):
        ...
        Input Parameters:
        	enable		 Enable history writing of tool methods? True means yes, False means no. True 
    ...
    def imageconcat(self, *args, **kwargs):
        """
        imageconcat(self, outfile, infiles, axis=-1, relax=False, tempclose=True, overwrite=False, reorder=False) -> image
    ...
    def fromarray(self, *args, **kwargs):
        """
        fromarray(self, outfile, pixels, csys, linear=False, overwrite=False, log=True, type) -> bool
        ...
        Input Parameters:
        	...
        	overwrite	 Overwrite the output image if it already exists? false 
        	log		 Write image creation messages to logger true 
        	type		 Pixel data type to write. 'f' (float precision) or 'd' (double precision) f 
    ...
    def fromascii(self, *args, **kwargs):
        """
        fromascii(self, outfile, infile, shape, sep, csys, linear=False, overwrite=False) -> bool



        Summary
        	THIS METHOD IS DEPRECATED AND WILL BE REMOVED IN THE NEAR FUTURE. This function converts a pre-existing ascii file into a casa image. 
    ...
    def fromcomplist(self, *args, **kwargs):
        """
        fromcomplist(self, outfile, shape, cl, csys, overwrite=False, log=True, cache=True) -> bool
        ...
        Input Parameters:
        	...
        	overwrite	 Overwrite (unprompted) pre-existing output file? false 
        	log		 Write image creation messages to logger true 
        	cache		 Cache pixel values for use while image is in use? true 
    ...
    def fromfits(self, *args, **kwargs):
        """
        fromfits(self, outfile, infile, whichrep=0, whichhdu=0, zeroblanks=False, overwrite=False) -> bool
    ...
    def fromimage(self, *args, **kwargs):
        """
        fromimage(self, outfile, infile, region, mask, dropdeg=False, overwrite=False) -> bool
    ...
    def fromshape(self, *args, **kwargs):
        """
        fromshape(self, outfile, shape, csys, linear=False, overwrite=False, log=True, type) -> bool
        ...
        Input Parameters:
        	...
        	overwrite	 Overwrite (unprompted) pre-existing output file? false 
        	log		 Write image creation messages to logger true 
        	type		 Data type of image pixels. 'f' (float), 'c' (complex float), 'd' (double), 'cd' (complex double). f 
    ...
    def maketestimage(self, *args, **kwargs):
        """
        maketestimage(self, outfile, overwrite=False) -> bool
    ...
    def deviation(self, *args, **kwargs):
        """
        deviation(self, outfile, region, mask, overwrite=False, stretch=False, grid, anchor, xlength, ylength, interp, stattype, statalg, zscore=-1, maxiter=-1) -> image
        ...
        Input Parameters:
        	...
        	overwrite	 Overwrite (unprompted) pre-existing output file? Ignored if 'outfile' is left blank. false 
        	stretch		 Stretch the mask if necessary and possible? Default value is False. false 
        	grid		 x,y grid spacing. Array of exactly two positive integers. 11 
        	anchor		 x,y anchor pixel location. Either 'ref' to use the image reference pixel, or an array of exactly two integers. ref 
        	xlength		 Either x coordinate length of box, or diameter of circle. Circle is used if ylength is empty string. 1pix 
        	ylength		 y coordinate length of box. Use a circle if ylength is empty string. 1pix 
        	interp		 Interpolation algorithm to use. One of 'nearest', 'linear', 'cubic', or 'lanczos'. Minimum match supported. cubic 
        	stattype	 Statistic to compute. See full description for supported statistics. sigma 
        	statalg		 Statistics computation algorithm to use. Supported values are 'chauvenet' and 'classic', Minimum match is supported. classic 
    ...
    def adddegaxes(self, *args, **kwargs):
        """
        adddegaxes(self, outfile, direction=False, spectral=False, stokes, linear=False, tabular=False, overwrite=False, silent=False) -> image
    ...
    def addnoise(self, *args, **kwargs):
        """
        addnoise(self, type, pars, region, zero=False, seeds) -> bool
    ...
    def convolve(self, *args, **kwargs):
        """
        convolve(self, outfile, kernel, scale=-1.0, region, mask, overwrite=False, stretch=False) -> image
    ...
    def boundingbox(self, *args, **kwargs):
        """
        boundingbox(self, region) -> record *
    ...
    def boxcar(self, *args, **kwargs):
        """
        boxcar(self, outfile, region, mask, axis=-1, width=2, drop=True, dmethod, overwrite=False, stretch=False) -> image
    ...
    def calcmask(self, *args, **kwargs):
        """
        calcmask(self, mask, name, asdefault=True) -> bool
    ...
    def continuumsub(self, *args, **kwargs):
        """
        continuumsub(self, outline, outcont, region, channels, pol, fitorder=0, overwrite=False) -> image
    ...
    def convertflux(self, *args, **kwargs):
        """
        convertflux(self, value, major, minor, type, topeak=True, channel=-1, polarization=-1) -> record *
    ...
    def convolve2d(self, *args, **kwargs):
        """
        convolve2d(self, outfile, axes, type, major, minor, pa, scale=-1, region, mask, overwrite=False, stretch=False, targetres=False, beam) -> image
    ...
    def coordsys(self, *args, **kwargs):
        """
        coordsys(self, axes) -> casac::coordsys *
    ...
    def coordmeasures(self, *args, **kwargs):
        """
        coordmeasures(self, pixel, dframe, sframe) -> record *
        ...
        Input Parameters:
        	...
        	dframe		 Direction reference frame to which to convert the direction data. Case insensitive. 'cl' means use the conversion layer, if present, of the image direction coordinate. 'native' means use the native native direction frame of the image. Other examples are 'J2000', 'B1950', 'GALACTIC', etc. cl 
        	sframe		 Spectral reference frame to which to convert the spectral data. Case insensitive. 'cl' means use the conversion layer, if present, of the image spectral coordinate. 'native' means use the native spectral reference frame of the image. Other examples are 'LSRK', 'CMB', 'LGROUP', etc. cl 
    ...
    def decompose(self, *args, **kwargs):
        """
        decompose(self, region, mask, simple=False, threshold=-1, ncontour=11, minrange=1, naxis=2, fit=True, maxrms=-1, maxretry=-1, maxiter=256, convcriteria=0.0001, stretch=False) -> record *
    ...
    def deconvolvecomponentlist(self, complist, channel=-1, polarization=-1):
        """
        ...
        """
        return _image.image_deconvolvecomponentlist(self, complist, channel, polarization)


    def deconvolvefrombeam(self, *args, **kwargs):
        """
        deconvolvefrombeam(self, source, beam) -> record *
    ...
    def beamforconvolvedsize(self, *args, **kwargs):
        """
        beamforconvolvedsize(self, source, convolved) -> record *
    ...
    def removefile(self, file):
        ...
        """
        return _image.image_removefile(self, file)
    ...
    def fft(self, *args, **kwargs):
        """
        fft(self, real, imag, amp, phase, axes, region, mask, stretch=False, complex) -> bool
        ...
        Input Parameters:
        	...
        	stretch		 Stretch the mask if it is necessary and possible. false 
    ...
    def findsources(self, *args, **kwargs):
        """
        findsources(self, nmax=20, cutoff=0.1, region, mask, point=True, width=5, negfind=False) -> record *
    ...
    def fitprofile(self, *args, **kwargs):
        """
        fitprofile(self, box, region, chans, stokes, axis=-1, mask, ngauss=1, poly=-1, estimates, minpts=1, multifit=False, model, residual, amp, amperr, center, centererr, fwhm, fwhmerr, integral, integralerr, stretch=False, logresults=True, pampest, pcenterest, pfwhmest, pfix, gmncomps, gmampcon, gmcentercon, gmfwhmcon, gmampest, gmcenterest, gmfwhmest, gmfix, spxtype, spxest, spxfix, div, spxsol, spxerr, logfile, append=True, pfunc, goodamprange, goodcenterrange, goodfwhmrange, sigma, outsigma, planes) -> record *
        ...
        Input Parameters:
        	box		 Rectangular region to select in direction plane. Default is to use the entire direction plane. 
        	region		 Region selection. Default is to use the full image. path string record 
        	chans		 Channels to use. Channels must be contiguous. Default is to use all channels.. 
        	...
        	estimates	 Name of file containing initial estimates. Default: No initial estimates (''). path 
    ...
    def fitcomponents(self, *args, **kwargs):
        """
        fitcomponents(self, box, region, chans, stokes, mask, includepix, excludepix, residual, model, estimates, logfile, append=True, newestimates, complist, overwrite=False, dooff=False, offset=0.0, fixoffset=False, stretch=False, rms, noisefwhm, summary) -> record *
    ...
    def fromrecord(self, *args, **kwargs):
        """
        fromrecord(self, record, outfile) -> bool
    ...
    def getchunk(self, *args, **kwargs):
        """
        getchunk(self, blc, trc, inc, axes, list=False, dropdeg=False, getmask=False) -> variant *
    ...
    def getregion(self, *args, **kwargs):
        """
        getregion(self, region, axes, mask, list=False, dropdeg=False, getmask=False, stretch=False) -> variant *
        ...
        Input Parameters:
        	...
        	stretch		 Stretch the mask if necessary and possible? Default False false 
    ...
    def getprofile(self, *args, **kwargs):
        """
        getprofile(self, axis=-1, function, region, mask, unit, stretch=False, spectype, restfreq, frame, logfile) -> record *
    ...
    def getslice(self, *args, **kwargs):
        """
        getslice(self, x, y, axes, coord, npts=0, method) -> record *
    ...
    def hanning(self, *args, **kwargs):
        """
        hanning(self, outfile, region, mask, axis=-10, drop=True, overwrite=False, stretch=False, dmethod) -> image
    ...
    def histograms(self, *args, **kwargs):
        """
        histograms(self, axes, region, mask, nbins=25, includepix, cumu=False, log=False, stretch=False) -> record *
        ...
        Input Parameters:
        	...
        	includepix	 Range of pixel values to include. Default is to include all pixels. -1 
        	cumu		 If T the bin values are cumulative. false 
        	log		 If true, the returned counts values will be the log10 values of the actual counts, if false, the actual counts will be returned. false 
        	stretch		 Stretch the mask if necessary and possible? Default False false 
    ...
    def insert(self, *args, **kwargs):
        """
        insert(self, infile, region, locate, verbose=False) -> bool
    ...
    def makecomplex(self, *args, **kwargs):
        """
        makecomplex(self, outfile, imag, region, overwrite=False) -> bool
    ...
    def maskhandler(self, *args, **kwargs):
        """
        maskhandler(self, op, name) -> std::vector< std::string >
    ...
    def modify(self, *args, **kwargs):
        """
        modify(self, model, region, mask, subtract=True, list=True, stretch=False) -> bool
    ...
    def maxfit(self, *args, **kwargs):
        """
        maxfit(self, region, point=True, width=5, negfind=False, list=True) -> record *
    ...
    def moments(self, *args, **kwargs):
        """
        moments(self, moments, axis=-10, region, mask, method, smoothaxes, smoothtypes, smoothwidths, includepix, excludepix, peaksnr=3.0, stddev=0.0, doppler, outfile, smoothout, overwrite=False, drop=True, stretch=False) -> image
    ...
    def open(self, infile, cache=True):
        """
        open(self, infile, cache=True) -> bool
        ...
        Input Parameters:
        	...
        	cache		 Cache pixel values for use while image is in use? Ignored if image being opened is not a ComponentListImage. true 
    ...
    def pad(self, *args, **kwargs):
        """
        pad(self, outfile, npixels=1, value=0, padmask=False, overwrite=False, region, box, chans, stokes, mask, stretch=False, wantreturn=True) -> image
    ...
    def crop(self, *args, **kwargs):
        """
        crop(self, outfile, axes, overwrite=False, region, box, chans, stokes, mask, stretch=False, wantreturn=True) -> image
    ...
    def putchunk(self, *args, **kwargs):
        """
        putchunk(self, pixels, blc, inc, list=False, locking=True, replicate=False) -> bool
    ...
    def putregion(self, *args, **kwargs):
        """
        putregion(self, pixels, pixelmask, region, list=False, usemask=True, locking=True, replicate=False) -> bool
    ...
    def rebin(self, *args, **kwargs):
        """
        rebin(self, outfile, bin, region, mask, dropdeg=False, overwrite=False, stretch=False, crop=False) -> image
    ...
    def regrid(self, *args, **kwargs):
        """
        regrid(self, outfile, shape, csys, axes, region, mask, method, decimate=10, replicate=False, doref=True, dropdeg=False, overwrite=False, force=False, asvelocity=False, stretch=False) -> image
    ...
    def transpose(self, *args, **kwargs):
        """
        transpose(self, outfile, order) -> image
    ...
    def rotate(self, *args, **kwargs):
        """
        rotate(self, outfile, shape, pa, region, mask, method, decimate=0, replicate=False, dropdeg=False, overwrite=False, stretch=False) -> image
    ...
    def replacemaskedpixels(self, *args, **kwargs):
        """
        replacemaskedpixels(self, pixels, region, mask, update=False, list=False, stretch=False) -> bool
    ...
    def beamarea(self, channel=-1, polarization=-1):
        """
        beamarea(self, channel=-1, polarization=-1) -> record *
        ...
        """
        return _image.image_beamarea(self, channel, polarization)


    def restoringbeam(self, channel=-1, polarization=-1):
        """
        ...
        """
        return _image.image_restoringbeam(self, channel, polarization)


    def sepconvolve(self, *args, **kwargs):
        """
        sepconvolve(self, outfile, axes, types, widths, scale=-1, region, mask, overwrite=False, stretch=False) -> image
    ...
    def set(self, *args, **kwargs):
        """
        set(self, pixels, pixelmask=-1, region, list=False) -> bool
    ...
    def setbrightnessunit(self, unit):
        ...
        """
        return _image.image_setbrightnessunit(self, unit)
    ...
    def setcoordsys(self, csys):
        ...
        """
        return _image.image_setcoordsys(self, csys)


    def sethistory(self, *args, **kwargs):
        """
        sethistory(self, origin, history) -> bool
    ...
    def setmiscinfo(self, info):
        ...
        """
        return _image.image_setmiscinfo(self, info)
    ...
    def setrestoringbeam(self, *args, **kwargs):
        """
        setrestoringbeam(self, major, minor, pa, beam, remove=False, log=True, channel=-1, polarization=-1, imagename) -> bool
    ...
    def statistics(self, *args, **kwargs):
        """
        statistics(self, axes, region, mask, includepix, excludepix, list=False, force=False, disk=False, robust=False, verbose=False, stretch=False, logfile, append=True, algorithm, fence=-1, center, lside=True, zscore=-1, maxiter=-1, clmethod, niter=3) -> record *
        ...
        * biweight: The biweight algorithm is a robust iterative algorithm that computes two
        ...
        Input Parameters:
        	...
        	append		 Append results to logfile? Logfile must be specified. Default is to append. False means overwrite existing file if it exists. true 
        	algorithm	 Algorithm to use. Supported values are 'biweight', 'chauvenet', 'classic', 'fit-half', and 'hinges-fences'. Minimum match is supported. classic 
        	...
        	zscore		 For chauvenet, this is the target maximum number of standard deviations data may have to be included. If negative, use Chauvenet's criterion. Ignored if algorithm is not 'chauvenet'. -1 
        	maxiter		 For chauvenet, this is the maximum number of iterations to attempt. Iterating will stop when either this limit is reached, or the zscore criterion is met. If negative, iterate until the zscore criterion is met. Ignored if algorithm is not 'chauvenet'. -1 
        	...
        	niter		 For biweight, this is the maximum number of iterations to attempt. Iterating will stop when either this limit is reached, or the zscore criterion is met. If negative, do a fast, simple computation (see description). Ignored if the algorithm is not 'chauvenet'. 3 
    ...
    def twopointcorrelation(self, *args, **kwargs):
        """
        twopointcorrelation(self, outfile, region, mask, axes, method, overwrite=False, stretch=False) -> bool
    ...
    def subimage(self, *args, **kwargs):
        """
        subimage(self, outfile, region, mask, dropdeg=False, overwrite=False, list=True, stretch=False, wantreturn=True, keepaxes) -> image
    ...
    def summary(self, *args, **kwargs):
        """
        summary(self, doppler, list=True, pixelorder=True, verbose=False) -> record *
    ...
    def tofits(self, *args, **kwargs):
        """
        tofits(self, outfile, velocity=False, optical=True, bitpix=-32, minpix=1, maxpix=-1, region, mask, overwrite=False, dropdeg=False, deglast=False, dropstokes=False, stokeslast=True, wavelength=False, airwavelength=False, stretch=False, history=True) -> bool
    ...
    def toASCII(self, *args, **kwargs):
        """
        toASCII(self, outfile, region, mask, sep, format, maskvalue=-999, overwrite=False, stretch=False) -> bool



        Summary
        	THIS METHOD IS DEPRECATED AND WILL BE REMOVED IN THE NEAR FUTURE. Convert the image to an ASCII file
    ...
    def topixel(self, value):
        ...
        """
        return _image.image_topixel(self, value)


    def toworld(self, *args, **kwargs):
        """
        toworld(self, value, format, dovelocity) -> record *
        ...
        Input Parameters:
        	...
        	dovelocity	 Compute corresponding spectral velocities if format='m'? True 
    ...
    def newimagefromarray(self, *args, **kwargs):
        """
        newimagefromarray(self, outfile, pixels, csys, linear=False, overwrite=False, log=True, type) -> image
    ...
    def newimagefromfits(self, *args, **kwargs):
        """
        newimagefromfits(self, outfile, infile, whichrep=0, whichhdu=0, zeroblanks=False, overwrite=False) -> image
    ...
    def newimagefromimage(self, *args, **kwargs):
        """
        newimagefromimage(self, infile, outfile, region, mask, dropdeg=False, overwrite=False) -> image
    ...
    def newimagefromshape(self, *args, **kwargs):
        """
        newimagefromshape(self, outfile, shape, csys, linear=False, overwrite=False, log=True, type) -> image
    ...
    def pbcor(self, *args, **kwargs):
        """
        pbcor(self, pbimage, outfile, overwrite=False, box, region, chans, stokes, mask, mode, cutoff=-1.0, stretch=False) -> image
    ...
    def pv(self, *args, **kwargs):
        """
        pv(self, outfile, start, end, center, length, pa, width, unit, overwrite=False, region, chans, stokes, mask, stretch=False, wantreturn=True) -> image
    ...
    def makearray(self, *args, **kwargs):
        """
        makearray(self, v=0.0, shape) -> variant *
    ...
    def isconform(self, other):
        ...
        """
        return _image.image_isconform(self, other)
