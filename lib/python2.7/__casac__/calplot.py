...
if _swig_python_version_info >= (2, 7, 0):
    def swig_import_helper():
        ...
        mname = '.'.join((pkg, '_calplot')).lstrip('.')
        try:
            return importlib.import_module(mname)
        except ImportError:
            return importlib.import_module('_calplot')
...
class calplot(_object):
    ...
    def plotoptions(self, *args, **kwargs):
        """
        plotoptions(self, subplot=111, overplot=False, iteration, plotrange, showflags=False, plotsymbol, plotcolor, markersize=5.0, fontsize=10.0) -> bool
    ...
    def markflags(self, *args, **kwargs):
        """
        markflags(self, panel=0, region) -> bool
    ...
    def selectcal(self, *args, **kwargs):
        """
        selectcal(self, antenna, field, spw, time, poln) -> bool
