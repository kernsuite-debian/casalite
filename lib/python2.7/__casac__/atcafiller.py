...
class atcafiller(_object):
    ...
    def open(self, *args, **kwargs):
        """
        open(self, msname, filenames, options) -> bool
    ...
    def select(self, *args, **kwargs):
        """
        select(self, firstscan=0, lastscan=9999, spw, lowfreq, highfreq, fields, edge=8.0) -> bool
        ...
        Input Parameters:
        	firstscan	 First scan to read 0 
        	lastscan	 Last scan to read 9999 
        	spw		 Select one or more spectralwindows , -1=all -1 
        	lowfreq		 Lowest reference frequency to select 0.1 
        	highfreq	 Highest reference frequency to select 999.0 
        	fields		 List of field names (sources) to select 
        	edge		 Percentage of edge channels to flag 8.0 
