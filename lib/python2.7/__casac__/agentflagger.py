...
class agentflagger(_object):
    ...
    def open(self, *args, **kwargs):
        """
        open(self, msname, ntime=0.0) -> bool
    ...
    def selectdata(self, *args, **kwargs):
        """
        selectdata(self, config, field, spw, array, feed, scan, antenna, uvrange, timerange, correlation, intent, observation) -> bool
    ...
    def parseagentparameters(self, aparams):
        ...
        """
        return _agentflagger.agentflagger_parseagentparameters(self, aparams)
    ...
    def run(self, writeflags=True, sequential=True):
        ...
        Input Parameters:
        	writeflags	 Write flags to MS (default: True) true 
    ...
    def saveflagversion(self, *args, **kwargs):
        """
        saveflagversion(self, versionname, comment, merge) -> bool
    ...
    def restoreflagversion(self, *args, **kwargs):
        """
        restoreflagversion(self, versionname, merge) -> bool
    ...
    def deleteflagversion(self, *args, **kwargs):
        """
        deleteflagversion(self, versionname) -> bool
    ...
    def parsemanualparameters(self, *args, **kwargs):
        """
        parsemanualparameters(self, field, spw, array, feed, scan, antenna, uvrange, time, correlation, intent, observation, autocorr=False, apply=True) -> bool
    ...
    def parseclipparameters(self, *args, **kwargs):
        """
        parseclipparameters(self, field, spw, array, feed, scan, antenna, uvrange, time, correlation, intent, observation, datacolumn, clipminmax, clipoutside=True, channelavg=False, chanbin, timeavg=False, timebin, clipzeros=False, apply=True) -> bool
        ...
        Input Parameters:
        	...
        	chanbin		 Width (bin) of input channels to average to form an output channel. 1 
    ...
    def parsequackparameters(self, *args, **kwargs):
        """
        parsequackparameters(self, field, spw, array, feed, scan, antenna, uvrange, time, correlation, intent, observation, quackmode, quackinterval=0.0, quackincrement=False, apply=True) -> bool
        ...
        Input Parameters:
        	...
        	quackincrement	 Increment quack flagging in time taking into account flagged data or not. Default: false 
        	apply		 Parameter to flag or unflag the data. Default: true 
    ...
    def parseelevationparameters(self, *args, **kwargs):
        """
        parseelevationparameters(self, field, spw, array, feed, scan, antenna, uvrange, time, correlation, intent, observation, lowerlimit=0.0, upperlimit=90.0, apply=True) -> bool
    ...
    def parsetfcropparameters(self, *args, **kwargs):
        """
        parsetfcropparameters(self, field, spw, array, feed, scan, antenna, uvrange, time, correlation, intent, observation, ntime=0.0, combinescans=False, datacolumn, timecutoff=4.0, freqcutoff=3.0, timefit, freqfit, maxnpieces=7, flagdimension, usewindowstats, halfwin=1, extendflags=True, apply=True, channelavg=False, chanbin, timeavg=False, timebin) -> bool
    ...
    def parseantintparameters(self, *args, **kwargs):
        """
        parseantintparameters(self, field, spw, array, feed, scan, antenna, uvrange, time, correlation, intent, observation, antint_ref_antenna, minchanfrac=0.6, verbose=False, apply=True) -> bool
        ...
        Input Parameters:
        	...
        	minchanfrac	 Minimum fraction of flagged channels required for a baseline to be deemed as flagged. Default: 0.6 
        	verbose		 Print timestamps of flagged integrations to the log. Default: false 
        	apply		 Parameter to flag or unflag the data. Default: true 
    ...
    def parseextendparameters(self, *args, **kwargs):
        """
        parseextendparameters(self, field, spw, array, feed, scan, antenna, uvrange, time, correlation, intent, observation, ntime=0.0, combinescans=False, extendpols=True, growtime=50.0, growfreq=50.0, growaround=False, flagneartime=False, flagnearfreq=False, apply=True) -> bool
    ...
    def parsesummaryparameters(self, *args, **kwargs):
        """
        parsesummaryparameters(self, field, spw, array, feed, scan, antenna, uvrange, time, correlation, intent, observation, spwchan=False, spwcorr=False, basecnt=False, fieldcnt=False, name) -> bool
