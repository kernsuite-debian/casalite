...
class synthesisdeconvolver(_object):
    ...
    def setupdeconvolution(self, *args, **kwargs):
        """
        setupdeconvolution(self, decpars) -> bool
    ...
    def interactivegui(self, *args, **kwargs):
        """
        interactivegui(self, iterbotrecord) -> record *
    ...
    def estimatememory(self, *args, **kwargs):
        """
        estimatememory(self, imsize) -> variant *
    ...
    def executeminorcycle(self, *args, **kwargs):
        """
        executeminorcycle(self, iterbotrecord) -> record *
