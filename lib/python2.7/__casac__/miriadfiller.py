...
class miriadfiller(_object):
    ...
    def fill(self, *args, **kwargs):
        """
        fill(self, vis, inputfile, tsys=False, spw, vel, linecal=False, wide, debug=0)
        ...
        Input Parameters:
        	...
        	tsys		 Fill weights from Tsys in data? false 
        	spw		 Spectral windows to load, default=all -1 
        	vel		 Velocity system to use (LSRK, LSRD, TOPO)? Default is telescope dependent 
        	linecal		 (CARMA) Apply line calibration false 
        	wide		 (CARMA) Select wide window averages 
        	debug		 Display increasingly verbose debug messages 0 
