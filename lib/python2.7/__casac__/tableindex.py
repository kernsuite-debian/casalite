...
if _swig_python_version_info >= (2, 7, 0):
    def swig_import_helper():
        ...
        mname = '.'.join((pkg, '_tableindex')).lstrip('.')
        try:
            return importlib.import_module(mname)
        except ImportError:
            return importlib.import_module('_tableindex')
...
class tableindex(_object):
    ...
    def set(self, tab, columns, sort=True):
        """
        ...
        """
        return _tableindex.tableindex_set(self, tab, columns, sort)
    ...
    def rownr(self, key):
        ...
        """
        return _tableindex.tableindex_rownr(self, key)


    def rownrs(self, *args, **kwargs):
        """
        rownrs(self, key, upperkey, lowerincl=True, upperincl=True) -> std::vector< int >
