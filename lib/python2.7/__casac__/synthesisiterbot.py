...
if _swig_python_version_info >= (2, 7, 0):
    def swig_import_helper():
        ...
        mname = '.'.join((pkg, '_synthesisiterbot')).lstrip('.')
        try:
            return importlib.import_module(mname)
        except ImportError:
            return importlib.import_module('_synthesisiterbot')
...
class synthesisiterbot(_object):
    ...
    def setupiteration(self, *args, **kwargs):
        """
        setupiteration(self, iterpars) -> record *
    ...
    def cleanComplete(self, lastcyclecheck=False):
        """
        cleanComplete(self, lastcyclecheck=False) -> int
        ...
        Input Parameters:
        	lastcyclecheck	 Check using peak residual before major cycle. false 

        --------------------------------------------------------------------------------

        """
        return _synthesisiterbot.synthesisiterbot_cleanComplete(self, lastcyclecheck)
    ...
    def resetminorcycleinfo(self):
        ...
        """
        return _synthesisiterbot.synthesisiterbot_resetminorcycleinfo(self)
    ...
    def mergeexecrecord(self, *args, **kwargs):
        """
        mergeexecrecord(self, execrecord) -> bool
    ...
    def mergeinitrecord(self, *args, **kwargs):
        """
        mergeinitrecord(self, initrecord) -> bool
