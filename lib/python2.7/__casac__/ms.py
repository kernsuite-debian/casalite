...
class ms(_object):
    ...
    def open(self, *args, **kwargs):
        """
        open(self, thems, nomodify=True, lock=False, check=False) -> bool
        ...
        Input Parameters:
        	...
        	check		 Run additional internal integrity checks on the MS. false 
    ...
    def getdata(self, *args, **kwargs):
        """
        getdata(self, items, ifraxis=False, ifraxisgap=0, increment=1, average=False) -> record *
    ...
    def fromfits(self, *args, **kwargs):
        """
        fromfits(self, msfile, fitsfile, nomodify=True, lock=False, obstype=0, host, forcenewserver=False, antnamescheme) -> bool
        ...
        Input Parameters:
        	...
        	fitsfile	 uvfits file to read path 
    ...
    def fromfitsidi(self, *args, **kwargs):
        """
        fromfitsidi(self, msfile, fitsfile, nomodify=True, lock=False, obstype=0) -> bool
    ...
    def tofits(self, *args, **kwargs):
        """
        tofits(self, fitsfile, column, field, spw, baseline, time, scan, uvrange, taql, writesyscal=False, multisource=False, combinespw=False, writestation=False, padwithflags=False, overwrite=False) -> bool
    ...
    def listfits(self, fitsfile):
        ...
        """
        return _ms.ms_listfits(self, fitsfile)


    def asdmref(self, *args, **kwargs):
        """
        asdmref(self, abspath) -> string
    ...
    def concatenate(self, *args, **kwargs):
        """
        concatenate(self, msfile, freqtol, dirtol, weightscale=1., handling=0, destmsfile, respectname=False) -> bool
    ...
    def testconcatenate(self, *args, **kwargs):
        """
        testconcatenate(self, msfile, freqtol, dirtol, respectname=False) -> bool



        Summary
        	Concatenate only the subtables of two measurement sets
    ...
    def virtconcatenate(self, *args, **kwargs):
        """
        virtconcatenate(self, msfile, auxfilename, freqtol, dirtol, weightscale=1., respectname=True) -> bool
    ...
    def createmultims(self, *args, **kwargs):
        """
        createmultims(self, outputTableName, tables, subtables, nomodify=True, lock=False, copysubtables=False, omitsubtables) -> bool
    ...
    def split(self, *args, **kwargs):
        """
        split(self, outputms, field, spw, step, baseline, timebin, time, scan, uvrange, taql, whichcol, tileshape, subarray, combine, correlation, intent, obs) -> bool



        Summary
        	make a new ms from a subset of an existing ms, 
                 adjusting subtables and indices
    ...
    def partition(self, *args, **kwargs):
        """
        partition(self, outputms, field, spw, baseline, timebin, time, scan, uvrange, taql, whichcol, tileshape, subarray, combine, intent, obs) -> bool
    ...
    def summary(self, *args, **kwargs):
        """
        summary(self, verbose=False, listfile, listunfl=False, cachesize=50, overwrite=False, wantreturn=True) -> record *
        ...
        Input Parameters:
        	...
        	wantreturn	 If true, construct a record containing summary info and return it, else return nothing. If you don't need the record and just want the log output, setting this to False will provide a small performance increase. true 
    ...
    def getfielddirmeas(self, *args, **kwargs):
        """
        getfielddirmeas(self, dircolname, fieldid=0, time=0, format) -> variant *
        ...
        Input Parameters:
        	dircolname	 Name of the direction column in the FIELD table or 'EPHEMERIS_DIR'. PHASE_DIR PHASE_DIR DELAY_DIR REFERENCE_DIR EPHEMERIS_DIR 
    ...
    def writehistory(self, *args, **kwargs):
        """
        writehistory(self, message, parms, origin, msname, app) -> bool
    ...
    def writehistory_batch(self, *args, **kwargs):
        """
        writehistory_batch(self, messages, parms, origin, msname, app) -> bool
    ...
    def statistics(self, *args, **kwargs):
        """
        statistics(self, column, complex_value, useflags=True, useweights=False, spw, field, baseline, uvrange, time, correlation, scan, intent, array, obs, reportingaxes, timeaverage=False, timebin, timespan, maxuvwdistance=0.0) -> record *
        ...
        Input Parameters:
        	...
        	useweights	 Use the data weights. false 
        	...
        	timebin		 Time averaging interval. 0s 
        	timespan	 Boundaries to ignore in time averaging. Example: 'scan,state' 
        	maxuvwdistance	 Maximum separation of start-to-end baselines that can be included in an average. (meters) 0.0 
    ...
    def statisticsold(self, *args, **kwargs):
        """
        statisticsold(self, column, complex_value, useflags=True, spw, field, baseline, uvrange, time, correlation, scan, array, obs) -> record *
    ...
    def range(self, *args, **kwargs):
        """
        range(self, items, useflags=True, blocksize=10) -> record *
    ...
    def lister(self, *args, **kwargs):
        """
        lister(self, options, datacolumn, field, spw, antenna, timerange, correlation, scan, feed, array, observation, uvrange, average, showflags=False, msselect, pagerows=50, listfile) -> bool
    ...
    def msselect(self, *args, **kwargs):
        """
        msselect(self, items, onlyparse=False) -> bool
    ...
    def msseltoindex(self, *args, **kwargs):
        """
        msseltoindex(self, vis, spw, field, baseline, time, scan, uvrange, observation, polarization, taql) -> record *
    ...
    def selectpolarization(self, *args, **kwargs):
        """
        selectpolarization(self, wantedpol) -> bool
    ...
    def statwt(self, *args, **kwargs):
        """
        statwt(self, combine, timebin, slidetimebin=False, chanbin, minsamp=2, statalg, fence=-1, center, lside=True, zscore=-1, maxiter=-1, fitspw, excludechans=False, wtrange, preview=False, datacolumn) -> record *
        ...
        Input Parameters:
        	...
        	timebin		 Length for binning in time to determine statistics. Can either be integer to be multiplied by the representative integration time, a quantity (string) in time units. 0.001s 4 '300s' 
        	slidetimebin	 Use a sliding window for time binning, as opposed to time block processing? false True 
        	chanbin		 Channel bin width for computing weights. Can either be integer, in which case it is interpreted as number of channels to include in each bin, or a string 'spw' or quantity with frequency units. spw 5 1.5MHz 
        	minsamp		 Minimum number of visibilities required for computing weights in a sample. Must be >= 2. 2 10 
        	statalg		 Statistics algorithm to use for computing variances. Supported values are 'chauvenet', 'classic', 'fit-half', and 'hinges-fences'. Minimum match is supported. classic 'cl', 'ch', 'f', or 'h' 
        	fence		 Fence value for statalg='hinges-fences'. A negative value means use the entire data set (ie default to the 'classic' algorithm). Ignored if statalg is not 'hinges-fences'. -1 0.2 
        	center		 Center to use for statalg='fit-half'. Valid choices are 'mean', 'median', and 'zero'. Ignored if statalg is not 'fit-half'. mean 'mean', 'median', or 'zero' 
        	lside		 For statalg='fit-half', real data are <=; center? If false, real data are >= center. Ignored if statalg is not 'fit-half'. true True 
        	zscore		 For statalg='chauvenet', this is the target maximum number of standard deviations data may have to be included. If negative, use Chauvenet's criterion. Ignored if statalg is not 'chauvenet'. -1 3.5 
        	maxiter		 For statalg='chauvenet', this is the maximum number of iterations to attempt. Iterating will stop when either this limit is reached, or the zscore criterion is met. If negative, iterate until the zscore criterion is met. Ignored if statalg is not 'chauvenet'. -1 10 
        	fitspw		 Channels to include in the computation of weights. Specified as an MS select channel selection string. '0:5~30' 
        	excludechans	 If True: invert the channel selection in fitspw and exclude the fitspw selection from the computation of the weights. false True 
        	wtrange		 Range of acceptable weights. Data with weights outside this range will be flagged. Empty array (default) means all weights are good. [0.1, 10] 
        	preview		 Preview mode. If True, no data is changed, although the amount of data that would have been flagged is reported. false True or False 
        	datacolumn	 Data column to use to compute weights. Supported values are 'data', 'corrected', 'residual, and 'residual_data' (case insensitive, minimum match supported). corrected 'data' or 'corrected' 
    ...
    def oldstatwt(self, *args, **kwargs):
        """
        oldstatwt(self, dorms=False, byantenna=True, sepacs=True, fitspw, fitcorr, combine, timebin, minsamp=3, field, spw, antenna, timerange, scan, intent, array, correlation, obs, datacolumn) -> bool
    ...
    def regridspw(self, *args, **kwargs):
        """
        regridspw(self, outframe, mode, restfreq=-3E30, interpolation, start=-3E30, center=-3E30, bandwidth=-1., chanwidth=-1., hanning=True) -> bool
    ...
    def cvel(self, *args, **kwargs):
        """
        cvel(self, mode, nchan=-1, start, width, interp, phasec, restfreq, outframe, veltype, hanning=True) -> bool
    ...
    def hanningsmooth(self, *args, **kwargs):
        """
        hanningsmooth(self, datacolumn) -> bool
    ...
    def cvelfreqs(self, *args, **kwargs):
        """
        cvelfreqs(self, spwids, fieldids, obstime, mode, nchan=-1, start, width, phasec, restfreq, outframe, veltype, verbose=True) -> std::vector< double >
        ...
        Input Parameters:
        	...
        	mode		 'channel', 'velocity', 'frequency', or 'channel_b' channel 
        	nchan		 Number of channels, default = all -1 
        	start		 Start channel. 0 
        	width		 New channel width. 1 
        	phasec		 Phase center, default=first field in selection. 
        	restfreq	 Rest frequency. 1.4GHz 
        	outframe	 LSRK, LSRD, BARY, GALACTO, LGROUP, CMB, GEO, TOPO, or SOURCE default = keep reference frame. 
        	veltype		 Radio or optical. radio 
    ...
    def contsub(self, *args, **kwargs):
        """
        contsub(self, outputms, fitspw, fitorder=1, combine, spw, unionspw, field, scan, intent, correlation, obs, whichcol) -> bool
    ...
    def continuumsub(self, *args, **kwargs):
        """
        continuumsub(self, field, fitspw, spw, solint, fitorder=0, mode) -> bool
        ...
        Input Parameters:
        	...
        	mode		 Desired use of fit model (see above). subtract 
    ...
    def addephemeris(self, *args, **kwargs):
        """
        addephemeris(self, id=-1, ephemerisname, comment, field) -> bool
    ...
    def sort(self, *args, **kwargs):
        """
        sort(self, newmsname, columns) -> bool
    ...
    def iterinit(self, *args, **kwargs):
        """
        iterinit(self, columns, interval=0.0, maxrows=0, adddefaultsortcolumns=True) -> bool
    ...
    def ngetdata(self, *args, **kwargs):
        """
        ngetdata(self, items, ifraxis=False, ifraxisgap=0, increment=1, average=False) -> record *
    ...
    def niterinit(self, *args, **kwargs):
        """
        niterinit(self, columns, interval=0.0, maxrows=0, adddefaultsortcolumns=True) -> bool
    ...
    def nrowold(self, selected=False):
        """
        nrowold(self, selected=False) -> int
        ...
        """
        return _ms.ms_nrowold(self, selected)


    def rangeold(self, *args, **kwargs):
        """
        rangeold(self, items, useflags=True, blocksize=10) -> record *
    ...
    def selectinitold(self, datadescid=0, reset=False):
        """
        selectinitold(self, datadescid=0, reset=False) -> bool
        ...
        """
        return _ms.ms_selectinitold(self, datadescid, reset)


    def selectold(self, *args, **kwargs):
        """
        selectold(self, items) -> bool
    ...
    def selecttaqlold(self, *args, **kwargs):
        """
        selecttaqlold(self, msselect) -> bool
    ...
    def selectchannelold(self, nchan=1, start=0, width=1, inc=1):
        """
        selectchannelold(self, nchan=1, start=0, width=1, inc=1) -> bool
        ...
        """
        return _ms.ms_selectchannelold(self, nchan, start, width, inc)


    def selectpolarizationold(self, *args, **kwargs):
        """
        selectpolarizationold(self, wantedpol) -> bool
    ...
    def getdataold(self, *args, **kwargs):
        """
        getdataold(self, items, ifraxis=False, ifraxisgap=0, increment=1, average=False) -> record *
    ...
    def iterinitold(self, *args, **kwargs):
        """
        iterinitold(self, columns, interval=0.0, maxrows=0, adddefaultsortcolumns=True) -> bool
    ...
    def continuumsubold(self, *args, **kwargs):
        """
        continuumsubold(self, field, fitspw, spw, solint, fitorder=0, mode) -> bool
