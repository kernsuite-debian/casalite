...
class linearmosaic(_object):
    ...
    def defineoutputimage(self, *args, **kwargs):
        """
        defineoutputimage(self, nx=128, ny=-1, cellx, celly, imagecenter, outputimage, outputweight) -> bool
    ...
    def setoutputimage(self, *args, **kwargs):
        """
        setoutputimage(self, outputimage, outputweight, imageweighttype=1, weighttype=1) -> bool
    ...
    def saultweightimage(self, *args, **kwargs):
        """
        saultweightimage(self, outputimage, fracpeak=0.1) -> bool
    ...
    def setlinmostype(self, *args, **kwargs):
        """
        setlinmostype(self, linmostype) -> bool
    ...
    def makemosaic(self, *args, **kwargs):
        """
        makemosaic(self, images, weightimages, imageweighttype=1, weighttype=1) -> bool
