...
class calibrater(_object):
    ...
    def open(self, filename, compress=False, addcorr=True, addmodel=True):
        ...
        """
        return _calibrater.calibrater_open(self, filename, compress, addcorr, addmodel)


    def selectvis(self, *args, **kwargs):
        """
        selectvis(self, time, spw, scan, field, intent, observation, baseline, uvrange, chanmode, nchan=1, start=0, step=1, mstart, mstep, msselect) -> bool
    ...
    def setmodel(self, modelimage):
        ...
        """
        return _calibrater.calibrater_setmodel(self, modelimage)


    def setptmodel(self, *args, **kwargs):
        """
        setptmodel(self, stokes) -> bool
    ...
    def setapply(self, *args, **kwargs):
        """
        setapply(self, type, t=0.0, table, field, interp, select, calwt=False, spwmap, opacity) -> bool
    ...
    def validatecallib(self, *args, **kwargs):
        """
        validatecallib(self, callib) -> bool
    ...
    def setsolve(self, *args, **kwargs):
        """
        setsolve(self, type, t, table, append=False, preavg=-1.0, phaseonly=False, apmode, refant, refantmode, minblperant=4, solnorm=False, normtype, minsnr=0.0, combine, fillgaps=0, cfcache, painc=360.0, fitorder=0, fraction=0.1, numedge=-1, radius, smooth=True, zerorates=False, globalsolve=True, niter=100, delaywindow, ratewindow, solmode, rmsthresh) -> bool
        ...
        Input Parameters:
        	...
        	smooth		 [SINGLE-DISH SPECIFIC] Whether or not applying smoothing during double circle gain calibration for fast scanning data. Default is True. true 
        	zerorates	 [FRINGE-FIT SPECIFIC] Zero delay-rates in fringe fitting solution tables. false 
        	globalsolve	 [FRINGE-FIT SPECIFIC] Use global least-squares solver to improve fringe-fitting parameter estimates true 
        	niter		 [FRINGE-FIT SPECIFIC] Maximum number of iterations for global least-squares solver 100 
    ...
    def setsolvegainspline(self, *args, **kwargs):
        """
        setsolvegainspline(self, table, append=False, mode, splinetime=10800, preavg=0.0, npointaver=10, phasewrap=250, refant) -> bool
    ...
    def setsolvebandpoly(self, *args, **kwargs):
        """
        setsolvebandpoly(self, table, append=False, t, combine, degamp=3, degphase=3, visnorm=False, solnorm=True, maskcenter=0, maskedge=5.0, refant) -> bool
    ...
    def delmod(self, *args, **kwargs):
        """
        delmod(self, otf=False, field, spw, scr=False) -> bool
    ...
    def initweights(self, *args, **kwargs):
        """
        initweights(self, wtmode, dowtsp=False, tsystable, gainfield, interp, spwmap) -> bool
    ...
    def fluxscale(self, *args, **kwargs):
        """
        fluxscale(self, tablein, reference, tableout, transfer, listfile, append=False, refspwmap, gainthreshold=-1.0, antenna, timerange, scan, incremental=False, fitorder=1, display=False) -> record *
    ...
    def accumulate(self, *args, **kwargs):
        """
        accumulate(self, tablein, incrtable, tableout, field, calfield, interp, t=-1.0, spwmap) -> bool
    ...
    def specifycal(self, *args, **kwargs):
        """
        specifycal(self, caltable, time, spw, antenna, pol, caltype, parameter, infile, uniform=True) -> bool
        ...
        Input Parameters:
        	...
        	uniform		 Assume uniform calibration values across the array true 
    ...
    def smooth(self, *args, **kwargs):
        """
        smooth(self, tablein, tableout, field, smoothtype, smoothtime=60.0) -> bool
    ...
    def rerefant(self, *args, **kwargs):
        """
        rerefant(self, tablein, tableout, refantmode, refant) -> bool
        ...
        Input Parameters:
        	tablein		 Input calibration table 
        	tableout	 Output calibration table 
        	refantmode	 The refant application mode strict flexible 
        	refant		 Reference antenna. Default is none. 
    ...
    def listcal(self, *args, **kwargs):
        """
        listcal(self, caltable, field, antenna, spw, listfile, pagerows=50) -> bool
    ...
    def posangcal(self, *args, **kwargs):
        """
        posangcal(self, posangcor, tablein, tableout) -> bool
    ...
    def linpolcor(self, *args, **kwargs):
        """
        linpolcor(self, tablein, tableout, fields) -> bool
    ...
    def plotcal(self, *args, **kwargs):
        """
        plotcal(self, antennas, fields, spwids, plottype, tablename, polarization=1, multiplot=False, nx=1, ny=1, psfile) -> bool
    ...
    def modelfit(self, *args, **kwargs):
        """
        modelfit(self, vary, niter=0, compshape, par, file) -> std::vector< double >
    ...
    def createcaltable(self, caltable, partype, caltype, singlechan):
        """
        createcaltable(self, caltable, partype, caltype, singlechan) -> bool
        ...
        Input Parameters:
        	caltable	 Calibration table name Real Complex 
        ...
        """
        return _calibrater.calibrater_createcaltable(self, caltable, partype, caltype, singlechan)
    ...
    def updatecaltable(self, caltable):
        ...
        """
        return _calibrater.calibrater_updatecaltable(self, caltable)
    ...
    def parsecallibfile(self, filein):
        """
        parsecallibfile(self, filein) -> record *
        ...
        """
        return _calibrater.calibrater_parsecallibfile(self, filein)


    def setvi(self, old=False, quiet=False):
        """
        setvi(self, old=False, quiet=False) -> bool
        ...
        Input Parameters:
        	old		 Use old-style VI, if old=True, else use new VI2 false 
        	quiet		 Warn in logger, if quiet=False false 
        ...
        """
        return _calibrater.calibrater_setvi(self, old, quiet)
