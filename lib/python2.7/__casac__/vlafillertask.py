...
if _swig_python_version_info >= (2, 7, 0):
    def swig_import_helper():
        ...
        mname = '.'.join((pkg, '_vlafillertask')).lstrip('.')
        try:
            return importlib.import_module(mname)
        except ImportError:
            return importlib.import_module('_vlafillertask')
...
class vlafillertask(_object):
    ...
    def fill(self, *args, **kwargs):
        """
        fill(self, msname, inputfile, project, start, stop, centerfreq, bandwidth, bandname, source, subarray=0, qualifier=-65536, calcode, overwrite=False, freqtol, applytsys=True, keepautocorr=False, antnamescheme, useday=1, keepblanks=False, evlabands=True)
