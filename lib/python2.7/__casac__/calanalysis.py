...
class calanalysis(_object):
    ...
    def open(self, *args, **kwargs):
        ...
        Input Parameters:
        	caltable	 Python string containing the calibration table name. path 
    ...
    def get(self, *args, **kwargs):
        """
        get(self, field, antenna, timerange, spw, feed, axis, ap, norm=False, unwrap=False, jumpmax=0.0) -> record *
    ...
    def fit(self, *args, **kwargs):
        """
        fit(self, field, antenna, timerange, spw, feed, axis, ap, norm=False, unwrap=False, jumpmax=0.0, order, type, weight=False) -> record *
