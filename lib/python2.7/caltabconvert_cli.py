...
from types import *
from task_caltabconvert import caltabconvert
class caltabconvert_cli_:
    __name__ = "caltabconvert"
    rkey = None
    ...
    def __init__(self) :
       self.__bases__ = (caltabconvert_cli_,)
       self.__doc__ = self.__call__.__doc__

       self.parameters={'caltabold':None, 'vis':None, 'ptype':None, 'caltabnew':None, }
    ...
    def __call__(self, caltabold=None, vis=None, ptype=None, caltabnew=None, ):
...
directly.
        ...
        Arguments :
                ...
                vis: Name of the visibility file (MS) associated with the
old-style caltable.
                     Default: none
...
https://casa.nrao.edu/casadocs/
        ...
        self.__globals__['__last_task'] = 'caltabconvert'
        self.__globals__['taskname'] = 'caltabconvert'
        ###
        ...
        if useLocalDefaults :
           for item in function_signature_defaults.iteritems():
            ...
            myparams['caltabold'] = caltabold = self.parameters['caltabold']
            myparams['vis'] = vis = self.parameters['vis']
            myparams['ptype'] = ptype = self.parameters['ptype']
            myparams['caltabnew'] = caltabnew = self.parameters['caltabnew']
...
#
        ...
        trec = casac.casac.utils().torecord(pathname+'caltabconvert.xml')

        casalog.origin('caltabconvert')
        try :
          #if not trec.has_key('caltabconvert') or not casac.casac.utils().verify(mytmp, trec['caltabconvert']) :
            #return False

          casac.casac.utils().verify(mytmp, trec['caltabconvert'], True)
          scriptstr=['']
          ...
          if type(self.__call__.func_defaults) is NoneType:
              ...
              saveinputs('caltabconvert', 'caltabconvert.last', myparams, self.__globals__,scriptstr=scriptstr, do_save_inputs=do_full_logging)
          ...
          result = caltabconvert(caltabold, vis, ptype, caltabnew)
...
#            paramgui.setGlobals({})
#
#        paramgui.runTask('caltabconvert', myf['_ip'])
#        paramgui.setGlobals({})
#
#
#
...
#
#
    def description(self, key='caltabconvert', subkey=None):
        desc={'caltabconvert': 'Convert old-style caltables into new-style caltables.',
               'caltabold': 'Name of the old-style caltable',
    ...
    def itsdefault(self, paramname) :
        ...
        if a.has_key(paramname) :
              return a[paramname]
caltabconvert_cli = caltabconvert_cli_()
