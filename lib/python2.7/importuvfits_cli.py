...
class importuvfits_cli_:
    __name__ = "importuvfits"
    rkey = None
    ...
    def __init__(self) :
       self.__bases__ = (importuvfits_cli_,)
       self.__doc__ = self.__call__.__doc__

       self.parameters={'fitsfile':None, 'vis':None, 'antnamescheme':None, }
...
Convert a UVITS file to a CASA visiblity data set.
        ...
        self.__globals__['__last_task'] = 'importuvfits'
        self.__globals__['taskname'] = 'importuvfits'
        ###
...
#
        ...
        trec = casac.casac.utils().torecord(pathname+'importuvfits.xml')

        casalog.origin('importuvfits')
        try :
          #if not trec.has_key('importuvfits') or not casac.casac.utils().verify(mytmp, trec['importuvfits']) :
            #return False

          casac.casac.utils().verify(mytmp, trec['importuvfits'], True)
          scriptstr=['']
          ...
          if type(self.__call__.func_defaults) is NoneType:
              ...
              saveinputs('importuvfits', 'importuvfits.last', myparams, self.__globals__,scriptstr=scriptstr, do_save_inputs=do_full_logging)
...
#            paramgui.setGlobals({})
#
#        paramgui.runTask('importuvfits', myf['_ip'])
#        paramgui.setGlobals({})
#
#
#
...
#
#
    def description(self, key='importuvfits', subkey=None):
        desc={'importuvfits': 'Convert a UVFITS file to a CASA visibility data set',
               'fitsfile': 'Name of input UV FITS file',
               'vis': 'Name of output visibility file (MS)',
               'antnamescheme': 'VLA/EVLA/CARMA only; \'new\' or \'old\'; \'VA04\' or \'04\' for VLA ant 4',
    ...
    def itsdefault(self, paramname) :
        ...
        if a.has_key(paramname) :
              return a[paramname]
importuvfits_cli = importuvfits_cli_()
