...
from types import *
from task_importasap import importasap
class importasap_cli_:
    __name__ = "importasap"
    rkey = None
    ...
    def __init__(self) :
       self.__bases__ = (importasap_cli_,)
       self.__doc__ = self.__call__.__doc__

       self.parameters={'infile':None, 'outputvis':None, 'flagbackup':None, 'overwrite':None, 'parallel':None, }
...
Convert ASAP Scantable data  into a CASA visibility file (MS)
        ...
        self.__globals__['__last_task'] = 'importasap'
        self.__globals__['taskname'] = 'importasap'
        ###
...
#
        ...
        trec = casac.casac.utils().torecord(pathname+'importasap.xml')

        casalog.origin('importasap')
        try :
          #if not trec.has_key('importasap') or not casac.casac.utils().verify(mytmp, trec['importasap']) :
            #return False

          casac.casac.utils().verify(mytmp, trec['importasap'], True)
          scriptstr=['']
          ...
          if type(self.__call__.func_defaults) is NoneType:
              ...
              saveinputs('importasap', 'importasap.last', myparams, self.__globals__,scriptstr=scriptstr, do_save_inputs=do_full_logging)
          ...
          result = importasap(infile, outputvis, flagbackup, overwrite, parallel)
...
#            paramgui.setGlobals({})
#
#        paramgui.runTask('importasap', myf['_ip'])
#        paramgui.setGlobals({})
#
#
#
...
#
#
    def description(self, key='importasap', subkey=None):
        desc={'importasap': 'Convert ASAP Scantable data  into a CASA visibility file (MS)',
               'infile': 'Name of input ASAP Scantable data',
    ...
    def itsdefault(self, paramname) :
        ...
        if a.has_key(paramname) :
              return a[paramname]
importasap_cli = importasap_cli_()
